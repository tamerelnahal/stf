    ...
    switch (req.accepts(['json'])) {
      case 'json':
        requtil.validate(req, function() {
          ...
          .then(function() {
            var domain = "@docomodigital.com"
            var n = req.body.username.search(domain)
        	if(n != -1) {
        		var username = req.body.username.split(domain)
        		req.body.username = username[0]
        	}
          ...
          .then(function(user) {
            ...
            var token = jwtutil.encode({
              ...
              , displayName: ldaputil.displayName(user)
              , memberOfList: ldaputil.memberOfList(user)
              }
